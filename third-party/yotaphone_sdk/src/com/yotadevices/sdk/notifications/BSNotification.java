...
public class BSNotification implements Parcelable {
    ...
    // notification is in reference to something that is ongoing, like a phone
    // call.
    public static final int FLAG_ONGOING_EVENT = 2;

    // Bit to be bitwise-ored into the flags field that should be set if the
    // notification should not be canceled when the user clicks the Clear all
    // button
    public static final int FLAG_NO_CLEAR = 32;

    // Bit to be bitwise-ored into the flags field that if set, the audio will
    // be repeated until the notification is cancelled or the notification
    // window is opened.
    ...
    // The intent to execute when the notification is explicitly dismissed by
    // the user, either with the "Clear All" button or by swiping it away
    // individually.
    ...
    // The view that will represent this notification in the expanded status
    // bar.
    ...
    // Can be FULL_SCREEN_NOTIFICATION, HALF_SCREEN_NOTIFICATION,
    // BAR_NOTIFICATION, COUNTER
    ...
    public static class Builder {
        ...
        // Supply a�PendingIntent�to send when the notification is makes long
        // tap gesure
        ...
        // Add a timestamp pertaining to the notification (usually the time the
        // event occurred).
